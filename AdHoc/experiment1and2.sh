...
sleep 5
sh runSimpleExpAgent.sh 11000 AdHocTD 1 50 > logAdHocTD.log 

sh runSimpleExpServer.sh 10100 3 > serverAdHocVisit.log &
sleep 5
sh runSimpleExpAgent.sh 11100 AdHocVisit 1 50 > logAdHocVisit.log 

sh runSimpleExpServer.sh 10200 3 > serverTorrey.log &
sleep 5
sh runSimpleExpAgent.sh 11200 Torrey 1 50 > logTorrey.log 

sh runSimpleExpServer.sh 10300 3 > serverEpisodeSharing.log &
sleep 5
sh runSimpleExpAgent.sh 11300 EpisodeSharing 1 50 > logEpisodeSharing.log 

sh runSimpleExpServer.sh 10400 3 > serverSARSATile.log &
sleep 5
sh runSimpleExpAgent.sh 11400 SARSATile 1 50 > logSARSATile.log 

sh runSimpleExpServer.sh 10000 3 > serverRandom.log &
sleep 5
sh runSimpleExpAgent.sh 11000 Dummy 1 50 > logRandom.log 

#Experiment 2

sh runSimpleExpServer.sh 12000 3 > serverAdHocTDAction.log &
sleep 5
sh runSimpleExpAgent.sh 13000 AdHocTDAction 1 50 > logAdHocTDAction.log 

sh runSimpleExpServer.sh 12100 3 > serverAdHocVisitAction.log &
sleep 5
sh runSimpleExpAgent.sh 13100 AdHocVisitAction 1 50 > logAdHocVisitAction.log 

sh runSimpleExpServer.sh 12200 3 > serverTorreyAction.log &
sleep 5
sh runSimpleExpAgent.sh 13200 TorreyAction 1 50 > logTorreyAction.log 

sh runSimpleExpServer.sh 12300 3 > serverEpisodeSharingAction.log &
sleep 5
sh runSimpleExpAgent.sh 13300 EpisodeSharingAction 1 50 > logEpisodeSharingAction.log 
